...
def _render_shell():
    ...
    st.markdown("""
<style>
/* Ocultar sidebar y header completamente en auth */
...
.auth-field [data-baseweb="base-input"] {
    ...
    border: 0.5px solid #c9a84c55 !important;
    border-radius: 7px !important;
}
.auth-field [data-baseweb="base-input"]:focus-within {
    border-color: #c9a84c !important;
    box-shadow: 0 0 0 1px #c9a84c22, 0 0 16px #c9a84c0d !important;
}
.auth-field [data-baseweb="base-input"] input {
    background-color: #141414 !important;
    color: #e8e0cc !important;
    font-size: 13px !important;
    caret-color: #c9a84c !important;
}
/* Matar el rojo de Streamlit */
.auth-field [data-baseweb="input"] { box-shadow: none !important; border: none !important; }
.auth-field .stTextInput > div { box-shadow: none !important; }
...
/* "Crear Jugador" y "← Volver" como texto dorado sin botón */
...
""", unsafe_allow_html=True)
    ...
    if st.session_state.auth_mode == "login":
        with st.form("login_form"):
            ...
            st.markdown("""
<div style="height:0.5px;background:linear-gradient(to right,transparent 0%,#c9a84c77 25%,#c9a84c77 75%,transparent 100%);margin:20px 0 20px;"></div>
""", unsafe_allow_html=True)
